...
if __name__ == '__main__':
    ...
    M = ({'i','s','t','r','r1','v'}, \
           ...
           (('i','documentReady',['noop 0'],'s'),('s','clickRecenterButton',['showCP 0'],'r'),('s','mouseDownVertex',['selectV {data}'],'v'),('s','clickTriChooseButton',['showTP 0'],'t'),('t','clickOnCanvas',['hideTP 0'],'s'),('t','click',['hideTP 0'],'s'),('t','clickTriTypeChoice',['resetT {data}','hideTP 0'],'s'),('t','mouseDownVertex',['hideTP 0','selectV {data}'],'v'),('t','clickRecenterButton',['hideTP 0','showCP 0'],'r'),('r','click',['hideCP 0'],'s'),('r','clickOnCanvas',['hideCP 0'],'s'),('r','clickTriChooseButton',['hideCP 0','showTP 0'],'t'),('r','clickRecenterPane',['noop 0'],'r'),('r','clickRecenterTextBox',['noop 0'],'r'),('r','clickOnCanvas',['checkCT {data}'],'r1'),('r','recenterTextChange',['checkCT {data}'],'r1'),('r1','recenterTextFail',['errorCT 0'],'r'),('r1','recenterTextSucc',['moveC {data}','hideCP 0'],'s'),('v','mouseMove',['moveV {data}'],'v'),('v','mouseUpCanvas',['noop 0'],'s'),('v','mouseLeaveCanvas',['resetV 0'],'s')), \
           'i'
        )
